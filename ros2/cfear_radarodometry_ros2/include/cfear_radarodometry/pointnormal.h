...
private:
  ...
  // Visualization (rviz marker publishing) was stripped in the ROS2 port; these
  // are kept as no-ops so algorithm code keeps compiling. See the ROS1 tree for
  // the original implementation if marker debugging is ever needed again.
