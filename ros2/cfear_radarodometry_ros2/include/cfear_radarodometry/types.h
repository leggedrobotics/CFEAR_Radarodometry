...
public:
  ...
  RadarScan(const Eigen::Affine3d& pose_scan, const Eigen::Affine3d& Tmotion, const pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud_peaks, const pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud_nopeaks, const CFEAR_Radarodometry::MapNormalPtr& cloud_normal, const rclcpp::Time& t);
